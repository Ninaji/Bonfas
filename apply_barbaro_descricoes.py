"""Aplica as descrições limpas escritas à mão (barbaro_descricoes.py) sobre as
76 features de Bárbaro no DB, substituindo o texto poluído do parser.

Backup automático. Reporta qualquer feature sem descrição manual mapeada.
"""
from __future__ import annotations
import sqlite3, shutil, sys, time
from barbaro_descricoes import DESCRICOES, chave_para
