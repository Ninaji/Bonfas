"""Aplica as descrições limpas escritas à mão (bardo_descricoes.py) sobre as
76 features de Bardo no DB, substituindo o texto poluído do parser.

Backup automático. Reporta qualquer feature sem descrição manual mapeada.
"""
from __future__ import annotations
import sqlite3, shutil, sys, time
from bardo_descricoes import DESCRICOES, chave_para
